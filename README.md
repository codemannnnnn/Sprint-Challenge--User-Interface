...
Semantic html is the code that has meaning, code that structures your page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display block makes an element take up the entire block horizontally, display inline will lay block level elements beside eachother.
...
git allows developers to collaborate on code with ease from across the globe, it is necessary for success.
